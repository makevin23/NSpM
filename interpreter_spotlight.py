...
inputs = "How did Paul Walker die"
model_dir = "data"
input_dir = "data"
...
# TODO: find entities, store them, and replace them with placeholders
entities = find_entity(inputs)
inputs_ph = replace_entities(inputs, entities)
...
for placeholder, (entity, uri) in entities.items():
    ...
    finaltrans += uri+'\n'
finaltrans += "\n \n \n output qurey : \n"
finaltranso = translate(inputs_ph, input_dir)
